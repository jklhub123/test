...
void Get_error(float form_planning[100][9], int form_id){
	...
	Angel0 = (joint0_target_ang0 - joint0_rt_ang0)/180*3.14f;
	Angel1 = (joint0_target_ang1 - joint0_rt_ang1)/180*3.14f;
	
	fAngel0=asinf(1.141/2*(sinf(Angel0)+cosf(Angel0)*sinf(Angel1)));
	fAngel1=atanf(1.141/2*(tanf(Angel1)-tanf(Angel0)/cosf(Angel1)));
	pidcontrol0.error_angle = fAngel0/3.141f*180;
	pidcontrol1.error_angle = fAngel1/3.141f*180;
...
//	uint16_t * temp;
	...
	//printf("ang=%d",ang0);
	Angel0=(float)ang0 / 8192 * 3.141f;
	Angel1=(float)ang1 / 8192 * 3.141f;
	fAngel0=asinf(1.141/2*(sinf(Angel0)+cosf(Angel0)*sinf(Angel1)));
	fAngel1=atanf(1.141/2*(tanf(Angel1)-tanf(Angel0)/cosf(Angel1)));
//	ang0=(int)(fAngel0/3.141*8192);
//	ang1=(int)(fAngel1/3.141*8192);
	ang0=fAngel0/3.141f*180;
	ang1=fAngel1/3.141f*180;
//	printf("ang=%d",ang0);
                   ...
                   float target_angle0, float target_angle1, float target_angle2, float target_angle3)
{
  ...
  float err_a = (x1 - y1 + (y0 - x0 ))/1.414f;
  float err_b = (x1 + y1 - (y0 + x0 ))/1.414f;
  ...
  float err_a_j2 = (x1_j2 - y1_j2 + (y0_j2 - x0_j2 ))/1.414f;
  float err_b_j2 = (x1_j2 + y1_j2 - (y0_j2 + x0_j2 ))/1.414f; 
